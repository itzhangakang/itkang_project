...
import static com.github.andyczy.java.excel.CommonsUtils.isBlank;
...
public final class JSONUtil {
    ...
    public static JSONObject toJsonObject(Object o) {
        requireNonNull(0, "Object is null");
		if(o instanceof String){
			return JSONObject.parseObject(o.toString());
		}else{
			return JSONObject.parseObject(JSONUtil.toJson(o));
		}
    }
    ...
    public static JSONArray toJsonArray(Object o) {
        ...
        return JSONArray.parseArray(JSONUtil.toJson(o));
    }
